...
class CalculatorApp(QWidget):
    def __init__(self):
        ...
        self.ResultSpace.setAlignment(
            QtCore.Qt.AlignCenter | QtCore.Qt.AlignVCenter
        )  # for center align
        self.ResultSpace.setObjectName("result_space")
        self.ResultSpace.setStyleSheet(
            "QLabel#result_space {color: blue}"
        )  # change the colour of the result
